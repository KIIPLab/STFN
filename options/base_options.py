...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--d_name', type=str, default='TID', help='data name for train: PIPAL | KADID | LIVE | CSIQ | TID ')
        self._parser.add_argument('--db_path', type=str, default='dataa/TID/Train_images', help='path to train images : PIPAL | KADID | LIVE | CSIQ | TID in dir')
        ...
        self._parser.add_argument('--txt_file_name', type=str, default='data_list/TID_test.txt', help='training data list: PIPAL | KADID | LIVE | CSIQ | TID')
