...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--test_list', type=str, default='data_list/PIPAL_test.txt', help='testing data list')
        ...
        self._parser.add_argument('--batch_size', type=int, default=10, help='input batch size') #10 or 1
        self._parser.add_argument('--test_file_name', type=str, default='test_results_SFTN_Label.txt', help='txt path to save results')
        self._parser.add_argument('--n_ensemble', type=int, default=20, help='crop method for test(5 or 20): five points crop or nine points crop or random crop for several times')
