...
class RandomRotation(object):
    ...
    def __call__(self, sample):
        ...
        # Rotate the images
        r_img = self.rotate_image(r_img, angle)
        d_img = self.rotate_image(d_img, angle)
...
class AddGaussianNoise(object):
    ...
    def __call__(self, sample):
        ...
        r_img = r_img + torch.randn(r_img.size()) * self.std + self.mean
        d_img = d_img + torch.randn(d_img.size()) * self.std + self.mean
